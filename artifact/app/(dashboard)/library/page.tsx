...
import { getLibrary, latestDemoDate, search, type LibraryDay, type SearchHit } from "@/lib/api";
...
function LibraryContent() {
  ...
  // Public demo: anchored to the month this fixed dataset actually has days
  // for, not the visitor's own real current month.
  const [month] = useState(() => latestDemoDate().slice(0, 7));
  ...
  const todayDate = Number(latestDemoDate().slice(-2));
