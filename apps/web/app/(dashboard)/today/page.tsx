...
import { currentIsoWeek, isoWeekDates, shiftIsoWeek } from "@/lib/isoWeek";
...
/** The LOCAL calendar date. (This used to be `toISOString()`, which is UTC: in
 * an evening the browser could think it was already tomorrow while the server
 * — which names the day with its own local date — did not.) */
...
export default function TodayPage() {
  ...
  const week = useMemo(
    () => isoWeekDates(shiftIsoWeek(currentIsoWeek(), weekOffset)),
    [weekOffset],
  );
